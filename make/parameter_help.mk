...
parameter_help_hint_STRONG_CONSTANTS_SCOPE = soft | relaxed | full | none
parameter_help_description_STRONG_CONSTANTS_SCOPE = Constraint scope and placement of the single max-consts pass.
parameter_help_note_STRONG_CONSTANTS_SCOPE = soft runs before relaxed node selection; relaxed runs before hard selection.
parameter_help_note2_STRONG_CONSTANTS_SCOPE = full runs after lock under the complete specification.
parameter_help_note3_STRONG_CONSTANTS_SCOPE = none disables strong-constant optimization and elimination.
