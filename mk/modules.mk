...
clause_continuation_patience_params = \
	PATIENCE_SOFT PATIENCE_RELAXED PATIENCE_SEED PATIENCE_LOCK
...
target_params_clustering = \
	INTEGRATION ANALYSIS_HVG_METHOD ANALYSIS_HVG_TOP ANALYSIS_HVG_SPAN \
...
target_params_max-nodes-soft = \
	$(prior_knowledge_params) MAX_CLAUSE CANONICAL_FILTER CLAUSE_CONTINUATION_SOFT PATIENCE_SOFT \
...
target_params_max-nodes-relaxed = \
	$(prior_knowledge_params) MAX_CLAUSE CANONICAL_FILTER CLAUSE_CONTINUATION_RELAXED PATIENCE_RELAXED \
...
target_params_max-nodes-seed = \
	$(prior_knowledge_params) MAX_CLAUSE CANONICAL_FILTER CLAUSE_CONTINUATION_SEED PATIENCE_SEED \
	CLINGO_CONFIG_SEED CLINGO_OPT_MODE_SEED CLINGO_OPT_STRATEGY_SEED \
	JOBS_SEED TIMEOUT_SEED
target_params_max-nodes-lock = \
	$(prior_knowledge_params) MAX_CLAUSE CANONICAL_FILTER CLAUSE_CONTINUATION_LOCK PATIENCE_LOCK \
